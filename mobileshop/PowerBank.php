...
<head>
    <meta charset="utf-8">
    <title>Here is Power Bank Category</title>
...
<div class="PhoneType" style="height: 750px">

    <?php

    $sqlPowerbank = "SELECT * FROM powerbank";
    $show_result_Powerbank= $connect->query($sqlPowerbank);

    while ($row = $show_result_Powerbank->fetch_assoc())
    {
        $pathPowerbank = $row['Picture'];
