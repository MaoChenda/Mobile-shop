...
<head>
    <meta charset="utf-8">
    <title>Here is Charger Category</title>
...
<div class="PhoneType" style="height: 750px">
    ...
    $sqlCharger = "SELECT * FROM charger";
    $show_result_Charger= $connect->query($sqlCharger);

    while ($row = $show_result_Charger->fetch_assoc())
    {
        $pathCharger = $row['Picture'];
