...
<head>
    <meta charset="utf-8">
    <title>Here is LG Category</title>
...
<div class="navbar">
    <ul>
        ...
        <li class="dropdown"><a href="#" class="dropbtn">PHONES <span class="caret"></span> </a>
...
<div class="PhoneType" style="height: 1900px;">

    <?php

    $sqlLG = "SELECT * FROM lg";
