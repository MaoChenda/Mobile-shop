...
<head>
    <meta charset="utf-8">
    <title>Here is USB Cable Category</title>
...
<div class="PhoneType" style="height: 750px">
    ...
    $sqlUSBCable = "SELECT * FROM usbcable";
    $show_result_USBCable= $connect->query($sqlUSBCable);

    while ($row = $show_result_USBCable->fetch_assoc())
    {
        $pathUSBCable = $row['Picture'];
